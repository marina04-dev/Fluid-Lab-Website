...
const Projects = () => {
    ...
    const categories = [
        ...
        { value: 'environmental-applications', label: 'Environmental Applications' },
        { value: 'fluid-structure-interaction', label: 'Fluid-Structure Interaction' }
    ];
                ...
                <div className="container-custom">
                    <div className="text-center text-white">
                        ...
                        <p className="text-xl opacity-90 max-w-3xl mx-auto">
                            Explore our current and completed research initiatives in fluid mechanics and related fields
                        </p>
                    </div>
                </div>
            </section>
