        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-6">{error || 'The requested publication could not be found.'}</p>
        ...
        <div className="min-h-screen">
            ...
            <section className="pt-24 pb-8 bg-gray-50">
                <div className="container-custom">
                    <Link to="/publications" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-6">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-2xl font-bold text-blue-600">{publication.year}</span>
                    </div>
                            ...
                            <Card>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <dd className="mt-1 text-gray-900 capitalize">{publication.type}</dd>
                                    </div>
                                    ...
                                    {publication.journal && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-gray-900">{publication.journal}</dd>
                                        </div>
                                    )}
                                    ...
                                    {publication.volume && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-gray-900">{publication.volume}</dd>
                                        </div>
                                    )}
                                    ...
                                    {publication.issue && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-gray-900">{publication.issue}</dd>
                                        </div>
                                    )}
                                    ...
                                    {publication.pages && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-gray-900">{publication.pages}</dd>
                                        </div>
                                    )}
